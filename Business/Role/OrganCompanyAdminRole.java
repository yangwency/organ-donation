...
import userinterface.OrganCompanyAdmin.OrganCompanyAdminWorkAreaJPanel;

/**
 *
 * @author wency
 */
public class OrganCompanyAdminRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem system,PatientDirectory patientDirectory) {
        return new OrganCompanyAdminWorkAreaJPanel( userProcessContainer, system);
    }
}
