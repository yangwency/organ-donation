...
import userinterface.OrganCompanyStaff.OrganCompanyStaffJPanel;

/**
 *
 * @author wency
 */
public class OrganCompanyStaffRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem system,PatientDirectory patientDirectory) {
        return new OrganCompanyStaffJPanel(userProcessContainer,system,account);
    }
}
